...
class History:
    ...
    def save_history(self, filename: str = "simulation_history") -> None:
        """Save the simulation history to a JSON file in the history directory."""
        ...
        # Construct full path
        filepath = os.path.join(history_dir, filename + ".json")
